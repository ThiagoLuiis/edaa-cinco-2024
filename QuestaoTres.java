public class QuestaoTres {
    public static void main(String[] args) {
        ...
        int[] placas = {1008 ,1012 ,1014 ,1021 ,1026 ,1028 ,1035 ,1040 ,1046 ,1051,
            ...
            // Questao 1 - A
            BuscaTres.buscarEImprimirResultado(placas, 1860);
            // Questao 1 - B
            BuscaTres.buscarEImprimirResultado(placas, 1440);
            // Questao 1 - C
            BuscaTres.buscarEImprimirResultado(placas, 1521);
            // Questao 1 - D
            BuscaTres.buscarEImprimirResultado(placas, 1040);
            // Questao 1 - E
            BuscaTres.buscarEImprimirResultado(placas, 1225);
            // Questao 1 - F
            BuscaTres.buscarEImprimirResultado(placas, 1370);
            // Questao 1 - G
            BuscaTres.buscarEImprimirResultado(placas, 1579);
            // Questao 1 - H
            BuscaTres.buscarEImprimirResultado(placas, 1901);
            // Questao 1 - I
            BuscaTres.buscarEImprimirResultado(placas, 1515);
            // Questao 1 - J
            BuscaTres.buscarEImprimirResultado(placas, 1770);
            // Questao 1 - K
            BuscaTres.buscarEImprimirResultado(placas, 1620);
            // Questao 1 - L
            BuscaTres.buscarEImprimirResultado(placas, 1095);
            // Questao 1 - M
            BuscaTres.buscarEImprimirResultado(placas, 1263);
            // Questao 1 - N
            BuscaTres.buscarEImprimirResultado(placas, 1105);
    }
}
