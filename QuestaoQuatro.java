...
/*
            Onde o 1º guarda volume é o 151776, o 2º 152300 e o último guarda volume é o
            347999. Sabemos que Andrômeda está no guarda volume identificado por 285964,
            Galáxia do Olho Negro está no 199976 e Objeto de Hoag está no 323739.
            Construa uma solução que retorne o número(posição) do guarda volume de cada
            uma das 03 Galáxias identificadas dentro do museu Mast. */
    ...
    public static void main(String[] args) {
        int [] galaxias = {
            ...
            for(int i = 0;i<galaxias.length;i++){
                ...
                if(galaxias[i]==285964){
                    System.out.println("O índice do guarda volume que indentifica a Galáxia de Andrômeda é: "+(i + 1));
                }
                else if (galaxias[i]==199976) {
                    System.out.println("O índice do guarda volume que indentifica a Galáxia do Olho Negro é: "+(i + 1));
                }
                else if (galaxias[i]==323739) {
                    System.out.println("O índice do guarda volume que indentifica o Objeto de Hoag é: "+(i + 1));
                }
